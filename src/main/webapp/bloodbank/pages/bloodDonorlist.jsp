...
<body>
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
									<a style="display: none;" href="#" class="btn btn-primary marleft14"
										...
										<s:form action="searchdonorBloodbank" theme="simple" cssClass="form-inline search" name="searchform">
										  ...
										  <a href="#" type="button" class="btn btn-primary" onclick="adddonorRow('donortable')"><i class="fa fa-plus-circle"></i> Add Blood Donor</a>
										</s:form>
										</div>
										</div>
										<div class="" style="">
											<table class="table my-table xlstable table-bordered" id="donortable" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>Donor Name</th>
                                                <th>DOB</th>
                                                ...
                                                <th>Last Donation</th>
                                                <th>Weight (Kg) </th>
                                                <th>How often you donate blood?</th>
                                                <th>Contact No</th>
                                                <th>Email id</th>
                                                <th>Address</th>
                                                <th>City</th>
                                        ...
                                        <tbody>
                                           <s:iterator value="blooddonorsList">
                                            <tr id="<s:property value="id"/>">
                                                ...
                                                <td><s:property value="last_donation_date"/></td>
                                                <td><s:property value="weight"/></td>
                                                <td><s:property value="donor_state"/></td>
                                                <td><s:property value="phone"/></td>
                                                <td><s:property value="email"/></td>
                                                <td><s:property value="address"/></td>
                                               	<td><s:property value="city"/></td>
                                                <td><a href="#" onclick="editdonorajax(<s:property value="id"/>)"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;<a href="deletedonorBloodbank?id=<s:property value="id"/>" onclick="return cnfmDelete()" ><i class="fa fa-trash text-danger"></i></a></td>
                                            </tr>
                                            </s:iterator>
                                        </tbody>
                                    </table>
   ...
   <s:form action="adddonorBloodbank" id="donorform">
   
     <s:hidden name="name" id="tname"></s:hidden>
     <s:hidden name="dob" id="tdob"></s:hidden>
     <s:hidden name="gender" id="tgender"></s:hidden>
     <s:hidden name="blood_group" id="tblood_group"></s:hidden>
     <s:hidden name="weight" id="tweight"></s:hidden>
     <s:hidden name="donor_state" id="tdonor_state"></s:hidden>
     <s:hidden name="phone" id="tphone"></s:hidden>
     <s:hidden name="email" id="temail"></s:hidden>
     <s:hidden name="address" id="taddress"></s:hidden>
     <s:hidden name="city" id="tcity"></s:hidden>
