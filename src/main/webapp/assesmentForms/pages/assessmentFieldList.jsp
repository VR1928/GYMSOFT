...
<div class="">
							<div class="">
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										...
										<h4>All Assessment Field List</h4>
	...
	<div class="col-lg-12 col-md-12 topback2">
		<a class="btn btn-primary" href="addAssesmentMasterForms"><i
			class="fa fa-plus"></i> Add</a>
	</div>
	<!-- <div class="col-lg-2 col-md-2"></div>
	<div class="col-lg-3 col-md-6">
		<a class="width-full btn btn-primary" href="subHeadingListAssesmentMasterForms">View Sub Heading Of Fields</a>
	</div> -->
</div>
<br />
<div class="row">
	...
	<div class="col-lg-12">
		<div>
			<table id="results"
				...
				<thead>
					<tr>
						<th class="text-left">Field No</th>
				...
				<tbody>
					<s:if test="assessmentList.size!=0">
						<s:iterator value="assessmentList" status="rowstatus">
							<tr>
...
<s:form action="AssesmentMasterForms" name="paginationForm" id="paginationForm" theme="simple">
