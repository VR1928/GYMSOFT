...
<html>
  ...
  <body>
   ...
   <!--  <h1>CSS Notification Boxes</h1> -->
	...
	<div class="alert-box error"><span>Message: </span> Client has no assessment form <a href="showtemplateAssesmentForms">Click to show assessment from template list</a></div>
