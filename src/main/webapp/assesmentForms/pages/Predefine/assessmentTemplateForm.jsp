	...
	<div class="table-responsive">
		...
		<tbody>
			...
			<!-- 	<td></td>
				...
				<td style="font-size: 10px;"><input type="text" id="generalHealth" name="generalHealth" class="form-control showToolTip ppstyle" data-toggle = "tooltip" placeholder = "Enter General Health" title="Enter General Health"/></td>
			</tr>
			<tr>
				<!-- <td></td>
				<td>2</td> -->
				<td style="font-size: 10px;">Night pain</td>
				<td style="font-size: 10px;"><input type="text" id="nightPain" name="nightPain" class="form-control showToolTip ppstyle" data-toggle = "tooltip" placeholder = "Enter Night pain" title="Enter Night pain"/></td>
			</tr>
			<tr>
				<!-- <td></td>
				<td>3</td> -->
				<td style="font-size: 10px;">Family history</td>
				<td style="font-size: 10px;"><input type="text" id="familyHistory" name="familyHistory" class="form-control showToolTip ppstyle" data-toggle = "tooltip" placeholder = "Enter Family history" title="Enter Family history"/></td>
			</tr>
			<tr>
				<!-- <td></td>
				<td>4</td> -->
				<td style="font-size: 10px;">Psycho social</td>
				<td style="font-size: 10px;"><input type="text" id="psychoSocial" name="psychoSocial" class="form-control showToolTip ppstyle" data-toggle = "tooltip" placeholder = "Enter Psycho social" title="Enter Psycho social"/></td>
			</tr>
			<tr>
				<!-- <td></td>
				<td>5</td> -->
				<td style="font-size: 10px;">Surgery</td>
				<td style="font-size: 10px;"><input type="text" id="surgery" name="surgery" class="form-control showToolTip ppstyle" data-toggle = "tooltip" placeholder = "Enter Surgery" title="Enter Surgery"/></td>
			</tr>
			<tr>
				<!-- <td></td>
				<td>6</td> -->
				<td style="font-size: 10px;">Accidents</td>
				<td style="font-size: 10px;"><input type="text" id="accident" name="accident" class="form-control showToolTip ppstyle" data-toggle = "tooltip" placeholder = "Enter Accidents" title="Enter Accidents"/></td>
			</tr>
		</table>
...
<div class="row">
		...
		<div class="col-lg-6 col-md-8 col-sm-6 col-xs-6 hidden-print">
			<button type="button"  class="btn btn-primary"  value="Save" onclick="insertImagePhysio()">Save</button>
