...
<html lang="en">
 ...
 <link rel="stylesheet" href="_assets/newtheme/css/mbile.css">
   <script src="_assets/newtheme/js/ui.js"></script>
...
.animsition{margin-top: -12px!important;}
                    ...
                    <ul class="nav-left pull-left list-unstyled list-inline">
                       <!--  <li class="sidebar-collapse divided-right">
                         ...
                         <li class="divided-right">
                            <img src="dashboardicon/hospital-bed.png" class="img-responsive" style="width: 28px;margin-top: 7px;">
                        </li> 
                        <li class="divided-right">
                            <h4 style="color: #fff;line-height: 29px;font-size:12px;">IPD / Casualty / Day Care Dashboard </h4>
                        </li>
                    </ul>
                    <!-- Left-side navigation end -->
                    <!-- Right-side navigation -->
                    <ul class="nav-right pull-right list-inline hidden-xs">
