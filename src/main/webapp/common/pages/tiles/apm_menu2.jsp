                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
										...
										<%-- 	<script>
											...
											%>
                                            <li><a href="#" onclick="openPopup('manageClient')" title="Patients"><i class="fa fa-user"></i> <span><%=loginInfo.getPatientname_field() %>s</span></a></li>
                                            <%
												 }
											%>
											<%
                                            ...
                                            <li>
                                                <a href="#" title="Common Report"><i class="fa fa-bar-chart-o"></i>Reports</a>
                                                <ul>
                                                   	<li><a href="#" onclick="openPopup('paymentReportChargesRpt')"><i class="fa fa-caret-right"></i> Payment Report Big</a></li>
                                                 	<li><a href="#" onclick="openPopup('smallpaymentReportChargesRpt')"><i class="fa fa-caret-right"></i> Payment Report Small</a></li>
                                                 	<li><a href="#" onclick="openPopup('districtChargesRpt')"><i class="fa fa-caret-right"></i>District Level OPD Count</a></li>
                                                </ul>
                                            </li>
