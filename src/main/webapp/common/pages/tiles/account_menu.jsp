										...
										<%-- 	<script>
                                           ...
                                           <%--  <%
                                            ...
                                            <li class="hidden">
                                                ...
                                                <ul>
                                                    <li><a href="#" onclick="openPopup('ExpenceManagement')"><i class="fa fa-caret-right"></i> Expence Dashboard </a></li>
											...
											<li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="#" onclick="openPopup('PractitionerListCommission')"><i class="fa fa-caret-right"></i> Practitioners Commission Report</a></li>
                                                    ...
                                                    <li>
                                                        <a href="#"><i class="fa fa-caret-right"></i> Inventory Report</a>
                                                        <ul>
                                                            <li><a onclick="openPopup('salereportProduct')" href="#"><i class="fa fa-caret-right"></i> Sale Report</a></li>
                                                            <li><a onclick="openPopup('paymentreceivereportProduct')" href="#"><i class="fa fa-caret-right"></i> Payment Receive  Report</a></li>
                                                            <li><a onclick="openPopup('inventoryOpeningClosingProduct')" href="#"><i class="fa fa-caret-right"></i> Inventory Opening Closing</a></li>
                                                			<li><a onclick="openPopup('itemwisereportProduct')" href="#"><i class="fa fa-caret-right"></i> Item Wise Sale Report</a></li>
                                                			<li><a onclick="openPopup('itemwisestockreportProduct')" href="#"><i class="fa fa-caret-right"></i> Item Wise Stock Report</a></li>
		                                                   <li><a onclick="openPopup('supplierledgerreportProduct')" href="#"><i class="fa fa-caret-right"></i> Purchase Report</a></li>
		                                                   <li><a onclick="openPopup('expirymedicineProduct')" href="#"><i class="fa fa-caret-right"></i> Expiry Medicine Report</a></li>
                                                		  <li><a onclick="openPopup('productReceivedReportProduct')" href="#" ><i class="fa fa-caret-right"></i> GRN Report</a></li>
                                                		  <li><a onclick="openPopup('transferreportProduct')" href="#"><i class="fa fa-caret-right"></i> Indent Statement Report</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
