                    ...
                    <ul class="nav-left pull-left list-unstyled list-inline">
                        ...
                        <li class="dropdown divided-right settings hidden">
                         ...
                         <li class="divided-right">
                            <img src="dashboardicon/waste.png" class="img-responsive" style="width: 30px;margin-top: 7px;">
                        </li> 
                         <li class="divided-right">
                            <h4 style="color: #fff;line-height: 29px;font-size: 12px;">House Keeping Dashboard</h4>
                        </li> 
                    </ul>
