  ...
  <div id="wrap" class="animsition">
            ...
            <section id="header" class="displayblockweb displaynonemobile">
                <header class="clearfix">
                    ...
                    <ul class="nav-left pull-left list-unstyled list-inline hidden">
                    ...
                    <%LoginInfo loginInfo = LoginHelper.getLoginInfo(request); %>
                        ...
                        <s:if test="(#session.LOGIN_INFO != null)&&(#session.LOGGED_IN)">
                         ...
                         <% if(openedb.equals("opd")){%>
                           	 	<!--<img src="dashboardicon/stethoscope.png" class="img-responsive" style="width: 44px;">-->
                            <%}else{ %>
                          		<!--<img src="dashboardicon/staff.png" class="img-responsive" style="width: 44px;">-->
                          <% }%>
                        </li> 
                        </s:if>
                    <s:if test="(#session.LOGIN_INFO != null)&&(#session.LOGGED_IN)">
