...
function printExcel() {
       ...
       $(".xlstable").table2excel({
					exclude: ".noExl",
					name: "Treatment Episode List",
					filename: "treatmentlistReport",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
								...
								<div class="row ">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										<div>
											...
											<s:form action="treatmentEpisodeListClinical" theme="simple" id = "invoicerportfrm">
	...
	<div class="col-lg-12 col-md-12 topback2 hidden-print">	
		...
		<div class="form-inline">
			...
			<s:select cssStyle="height: 31px;padding: 0px" cssClass="form-control chosen-select" 
						...
						headerKey="0" theme="simple" headerValue="All Practitioner"  />
			</s:if>
			</div>
			...
			<div class="form-group">
				<div id="sendMailTreatmentId"></div> 
			</div>
		</div>
			...
			<s:actionmessage cssClass="messageDiv" />			
				<table class="my-table xlstable" style="width: 100%;">
					<thead>
						<tr>
							...
							<th>Paid By <a href="#" onclick="setSorting('invoicee','<s:property value="order"/>')"><i class="fa fa-sort"></i></a></th></th>							
							<th>Sessions</th>
							<th>Start Date <a href="#" onclick="setSorting('lastmodified','<s:property value="order"/>')"><i class="fa fa-sort"></i></a></th></th>	
							<th>Used Session</th>											
						</tr>
					</thead>
					<tbody>										
						...
						<tr >
							<td><%=srno%></td>
							<td><s:property value="abrivationid"/>/<s:property  value="clientId" /></td>
							<td><s:property  value="clientName" /></td>
							<td><s:property  value="diaryUser" /></td>
							<td><s:property  value="treatmentEpisodeName" /></td>
							<s:if test="payby=='Client'">
								<td>Self (<s:property  value="invoicee" />)</td>
							</s:if>
							<s:else>
								<td><s:property  value="payby" />	(<s:property  value="invoicee" />)</td>
							</s:else>
							<td><s:property  value="sessions" /></td>
							<td><s:property  value="treatmentStartDate" /></td>
							
							<td><s:property  value="usedSession" /></td>														
						</tr>
						<%srno++;%>
						</s:iterator>					
				</tbody>
				<s:else>
					<h3 class="text-center">
						<i class="fa fa-times text-danger"></i> Treatment Episode List not found!!
					</h3>
				</s:else>	
			</table>
		</div>
