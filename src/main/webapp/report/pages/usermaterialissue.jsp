...
<SCRIPT type="text/javascript">
	...
	function printReport() {
				  ...
				  $(".tablexls").table2excel({
					exclude: ".noExl",
					name: "User wise material issue",
					filename: "userwisematerialissueReport",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
...
<div class="col-lg-12 col-md-12 paddingnil">
	<s:form theme="simple" cssClass="form-inline search" action="userwisematerialissueReport">
	<form class="form-inline search">
		<div class="form-group">
			<span class="text-uppercase"><b>User Wise Material Issue Report</b> &nbsp; - &nbsp;</span>
		</div>
	...
	<div class="form-group pull-right" style="margin-right: 17px"	>
	...
	<%-- <div class="form-group">
		<s:select cssClass="form-control" list="#{'0':'by quantity', '1':'by valuation', '2':'Delivered'}" name="filteroforder" />
			...
			<div class="form-group" style="width:15%">
				<s:select name="department" list="userlist" listKey="userid" listValue="name" cssClass="form-control chosen-select" headerKey="0" headerValue="All User" theme="simple" ></s:select>
			</div>
			
			<div class="form-group" style="width:15%">
				<s:select cssClass="form-control chosen-select"  list="#{'0':'Select Indent Type', '1':'Direct Transfer', '2':'Request Transfer'}" name="fromwherefilter" />
			</div>
			<div class="form-group" style="width:15%">        
          			<s:select list="warehouseList" theme="simple" name="warehousefilter" headerKey="0" id="warehousefilter" headerValue="Select Warehouse"  listKey="id" listValue="name" cssClass="form-control chosen-select" />
          		</div>
	 <div class="form-group">
...
<div class="col-lg-12 col-md-12 col-xs-12" id="printableArea">
	...
	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										<h4 class="hidden-lg hidden-md visible-print"><span class="text-uppercase"><b>User Wise Material Issue Report</b> &nbsp;  &nbsp;</span></h4>
	</div>
<div id="page_printer">
	...
	<table class="table table-bordered table-striped tablexls" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
		<thead>
			<tr class="tableback">
				...
				<td class="thcoi" style="width: 35% ">User Name</td>
				<td class="thcoi" style="width: 10% ">Type</td>
				<td class="thcoi" style="width: 45% ">Product Name</td>
				<td class="thcoi" style="width: 20% ">Quantity</td>
