...
<script>
	...
	function printcancelInvoiceReportExcel() {
        ...
        $(".tablecancelinvoice").table2excel({
					...
					exclude_inputs: true
								...
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										...
										<h4>Daily Admission and Discharge Report</h4>

									</div>
								</div>
								<s:form action="ipddailyadddisSummary" theme="simple">
			...
			<br>
			 <label>Total Admissions:<s:property value="todaysadm"/></label><label>   &nbsp&nbsp&nbsp</label>
			  <label>Total Discharges:<s:property value="todaysdis"/></label>
		...
		<div id="newpost" class="col-lg-12 col-md-12 col-xs-12 col-sm-12 borderbot">
			...
			<%@ include file="/accounts/pages/letterhead.jsp" %>
							...
							<tr>
								...
								<th>Date</th>
								<th>Admission</th>
								<th>Cumulative Admission</th>
								<th>Discharge</th>
						 		<th>Cumulative Discharge</th>
						 		
							</tr>
					</thead>
					<tbody>
						<%int i=0; %>
						<s:iterator value="dailyIPDAdmsDischList">
					   		<tr>
					     		<td><%=++i %></td>
								<td><s:property value="date"/></td>
								<td><s:property value="admission"/></td>
								<td><s:property value="totaladmission"/></td>
								<td><s:property value="discharge"/></td>
								<td><s:property value="totaldischarge"/></td>
