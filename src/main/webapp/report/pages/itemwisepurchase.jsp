...
<div class="col-lg-12 col-md-12 paddingnil">
	<s:form theme="simple" cssClass="form-inline search" action="itemwisepurchaseReport">
	<div class="col-lg-12 col-md-12 topback2">
		<div class="form-group">
			<span class="text-uppercase"><b>Item/Vendor Wise Purchase Report</b> &nbsp; - &nbsp;</span>
		</div>
	</div>
	<div class="col-lg-12 col-md-12 topback2">
	...
	<%-- <div class="form-group">
		<s:select cssClass="form-control" list="#{'0':'by quantity', '1':'by valuation', '2':'Delivered'}" name="filteroforder" />
	</div> --%>
		<div class="form-group" style="width:100px;">
				<s:textfield name="product"  cssClass="form-control" placeholder="Search by product name" cssStyle="width:100%;"/>
				<%-- <s:select name="product" list="productlist" listKey="id" listValue="prod_name" cssClass="form-control chosen-select" headerKey="0" headerValue="All Product" theme="simple" ></s:select> --%>
		</div>
		...
		<div class="form-group" style="width:15%">
			<s:select list="categoryList" theme="simple" onchange="getsubcatagoryinitemwise(this.value)" cssClass="form-control chosen-select" id="categoryid" name="categoryid" listKey="id" listValue="name" headerKey="0" headerValue="Select Category" ></s:select>
		</div>
		
		<div class="form-group" style="width:15%" id="subcategorydiv">
			<s:select list="subcategoryList" theme="simple" cssClass="form-control chosen-select" id="subcategoryid" name="subcategoryid" listKey="id" listValue="name" headerKey="0" headerValue="Select Sub-Category" ></s:select>
		</div>
			
	 <div class="form-group">
		<button type="submit" onclick="submitgo()"  class="btn btn-primary">Go</button>
	</div>
	<div class="form-group pull-right">
		<!-- <a href="#" class="btn btn-warning" onclick="printDiv('printableArea')">Download Excel</a> -->
		<a href="#"  onclick="printReport()" title="Download CSV file" style="line-height: 26px;"><i class="fa fa-download"></i> Download Excel</a>
	</div>
	<div class="form-group pull-right">
		<a href="#" class="btn btn-warning" onclick="printDiv5('printableArea')">Print</a>
	</div>
	</form>
	<!-- </div> -->
	<!-- 
...
<div class="col-lg-12 col-md-12 col-xs-12" id="printableArea">
...
<div id="page_printer">
	<table class="table table-bordered table-striped tablexls" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
		<thead>
			<tr class="tableback">
				<!-- <th class="thcoi" style="width: 2% !important;">Sr.No</th> -->
				<td class="thcoi" style="width: 1%">Sr.no</td>
				<td class="thcoi" style="width: 10% ">Date</td>
				<td class="thcoi" style="width: 15% ">Vendor</td>
				<td class="thcoi" style="width: 7% ">Invoice No.</td>
				<td class="thcoi" style="width: 7% ">Invoice Date</td>
				<td class="thcoi" style="width: 15% ">Ware House</td>
				<td class="thcoi" style="width: 20% ">Product Name</td>
				<td class="thcoi" style="width: 10% ">Generic Name</td>
				<td class="thcoi" style="width: 7% ">Cat. Name</td>
				<td class="thcoi" style="width: 7% ">Sub. Cat.</td>
				<td class="thcoi" style="width: 7% ">Batch no</td>
				<td class="thcoi" style="width: 7% ">GRN No.</td>
				<td class="thcoi" style="width: 5% ">GST</td>
				<td class="thcoi" style="width: 5% ">Pack</td>
				<td class="thcoi" style="width: 5% ">Pack Quantity</td>
				<td class="thcoi" style="width: 5% ">Receive Quantity</td>
				<td class="thcoi" style="width: 5% ">Free Qty</td>
				<td class="thcoi" style="width: 5% ">In Stock</td>
				<td class="thcoi" style="width: 5% ">Sale Qty</td>
				<td class="thcoi" style="width: 5% ">Return Qty</td>
				<td class="thcoi" style="width: 7% ">MRP</td>
				<td class="thcoi" style="width: 7% ">Sale Price</td> 
				<td class="thcoi" style="width: 8% ">Per Unit Amount</td>
				<td class="thcoi" style="width: 8% ">Amount</td>
				<td class="thcoi" style="width: 8% ">Discount Amount</td>
				<td class="thcoi" style="width: 8% ">GST Amount</td>
				<td class="thcoi" style="width: 8% ">Gross Amount</td>
				<td class="thcoi" style="width: 8% ">Net Amount</td>
				
             </tr>
		</thead>
		<tbody>
			<%int i =1; %>
			<s:iterator value="departmaterialissuelist">
				<tr>
					<td><%=i++ %></td>
					...
					<td><s:property value="voucherdate"/></td>
					...
					<td><s:property value="received_qty"/></td>
					<td><s:property value="freeqty"/></td>
					<td><s:property value="stockqty"/></td>
