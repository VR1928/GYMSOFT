...
<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										...
										<h4>Dept Wise OT Revenue Report</h4>

									</div>

</div>
<form action="deptwise_otSummary" method="post">
...
<td >Sr. No.</td>
<td style="width: 30%">Dept Name</td>
<td  style="width: 30%">No. Of Procedures</td>
