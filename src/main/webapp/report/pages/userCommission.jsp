...
<s:form action="PractitionerListCommission" theme="simple" id = "userFrm">
...
<div class="row">
						...
						<% int srno = 1;%>
							<s:iterator value="practitionerList" status="rowstatus">
								<tr id="<s:property  value="practitionerId" />" >								
									...
									<td><s:property  value="totalAppNo" /></td>
	...
	<!-- visiting consultant commision -->
	<div class="xlstable1">
	<!-- <h3>Visiting Consultant Share</h3> -->
	<s:if test="vsitingchargeList.size!=0">	
	<table>
	<tr>
	<td>
	<h3>Visiting Consultant Share</h3>
...
<div class="row">
			...
			<s:actionmessage cssClass="messageDiv" />			
				<table class="my-table xlstable">
					...
					<tbody>										
						...
						<% int srno = 1;%>
							<s:iterator value="vsitingchargeList" status="rowstatus">
								<tr id="<s:property  value="practitionerId" />" >								
									<td><%=srno++%></td>	
									<td><s:property  value="practitionerName" /></td>
									<td><s:property  value="clinicLocation" /></td>
									<td><%=Constants.getCurrency(loginfo) %><s:property  value="revanue" /></td>
									<td><s:property  value="per" /></td>
									<td><%=Constants.getCurrency(loginfo) %><s:property  value="shareamt" /></td>
	...
	<s:else>
		<h3 class="text-center">
			<i class="fa fa-times text-danger"></i> No Visiting Share /Fee Report found!!
		</h3>
	</s:else>	
	<table class="hidden">
	<tr>
	...
	<!-- IPD consultant commision -->
	<!-- <h3>IPD Consultant Share</h3> -->
	<s:if test="ipcconsultingList.size!=0">	
	<table>
	<tr>
	<td>
	<h3>IPD consultant commision</h3>
	</td>
	</tr>
	</table>
...
<div class="row">
			...
			<s:actionmessage cssClass="messageDiv" />			
				<table class="my-table ">
					...
					<tbody>										
						...
						<% int srno = 1;%>
							<s:iterator value="ipcconsultingList" status="rowstatus">
								<tr id="<s:property  value="practitionerId" />" >								
									<td><%=srno++%></td>	
									<td><s:property  value="practitionerName" /></td>
									<td><s:property  value="clinicLocation" /></td>
	...
	<s:else>
		<h3 class="text-center">
			<i class="fa fa-times text-danger"></i> No IPD Share /Fee Report found!!
		</h3>
	</s:else>	
	<table class="hidden">
	<tr>
	...
	<!-- Surgeon commision -->
	<!-- <h3>Surgeon Share</h3> -->
	<s:if test="surgeonChargeList.size!=0">	
	<table>
	<tr>
	<td>
	<h3>Surgeon Share</h3>
...
<div class="row">
			...
			<s:actionmessage cssClass="messageDiv" />			
				<table class="my-table xlstable">
					...
					<tbody>										
						...
						<% int srno = 1;%>
							<s:iterator value="surgeonChargeList" status="rowstatus">
								<tr id="<s:property  value="practitionerId" />" >								
									<td><%=srno++%></td>	
									<td><s:property  value="practitionerName" /></td>
									<td><s:property  value="clinicLocation" /></td>
	...
	<s:else>
		<h3 class="text-center">
			<i class="fa fa-times text-danger"></i> No Surgeon Share /Fee Report found!!
		</h3>
	</s:else>	 
	</div>
