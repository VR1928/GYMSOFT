...
<SCRIPT type="text/javascript">
	...
	function printReport() {
				  ...
				  $(".tablexls").table2excel({
					exclude: ".noExl",
					name: "Non Movient Item issue",
					filename: "nonmovingitemReport",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
...
<div class="col-lg-12 col-md-12 paddingnil">
	<s:form theme="simple" cssClass="form-inline search" action="nonmovingitemReport">
	<div class="col-lg-12 col-md-12 topback2">
	
	<!-- div class="col-lg-10 col-md-10"> -->
		<form class="form-inline search">
		<div class="form-group">
			<span class="text-uppercase"><b>Non Moving Item Report</b> &nbsp; - &nbsp;</span>
		</div>
	...
	<div class="form-group">
		<s:select cssClass="form-control" list="#{'0':'Select Moving Type','1':'Non Moving', '2':'Slow Moving', '3':'Fast Moving'}" name="filteroforder" />
	</div>
	...
	<table class="table table-bordered table-striped tablexls" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
		<thead>
			<tr class="tableback">
				...
				<th class="thcoi" style="width: 49% ">Product Name</th>
				<th class="thcoi" style="width: 25% ">Stock</th>
				<th class="thcoi" style="width: 25% ">Status</th>
			 </tr>
		</thead>
		<tbody>
			...
			<%
				int i = 0;
			%>
			<s:iterator value="nonmovingitemlist">
				<tr>
					<td><%=(++i)%></td> 
