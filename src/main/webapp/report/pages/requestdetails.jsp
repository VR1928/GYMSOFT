...
<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 " style="padding-top: 20px">
	...
	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 " >
	<input type="text"  name="msg" id="msg" class="form-control" style="border-color: green;"><input type="button" class="btn btn-success" value="Send" onclick="sendsupportmsg('User',<s:property value="ticketid"/>)"><br><br>
