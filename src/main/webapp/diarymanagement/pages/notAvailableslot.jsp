...
<div id="login" class="blockdash_div">
		...
		<jsp:include page="/popupdialog/dialog/commonPopupDialog.jsp" /> 
			<jsp:include page="/dashboard/weekDashBoard.jsp" /> 
			...
			<br><br>
				...
				<%for(int i=1;i<=clinicendtime;i++){ %>
					<tr>
					    <td class="ui-state-default"  valign="top" style="font-size: 14px; font-weight: bold;"><span class="timeset"><%=ct %>:00</span></td>
