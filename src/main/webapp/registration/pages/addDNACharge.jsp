...
<div class="row">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			<li class="active">Add DNA Charge</li>
		</ol>
	</div>
</div>
...
<s:form action="saveDNAChargeClinicRegistration" theme="simple" method="post" enctype="multipart/form-data">
...
<div class="row">
	<div class="col-lg-12">	
		...
		<div class="col-lg-6 col-md-8">
			<s:submit cssClass="btn btn-primary" value="Save" onclick="return saveValidationDNA()"/>					
