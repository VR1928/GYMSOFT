...
<body id="his" class="appWrapper sidebar-xs-forced">
        ...
        <section id="">
             ...
             <div class="container-fluid" style="background-color: #efefef;">
					<a>
                        <h4><strong>Employee</strong> Report</h4>
                    </a>
                    </div>
                ...
                <div class="pageheader">
                    ...
                    <form class="form-inline" style="background-color: rgb(242, 242, 242);padding: 13px;">
					  <div class="form-group">
					    ...
					    <s:select name="branch" id="branch" list="branchlist" listKey="branch_id" onchange="sortEmployees(this.value)" listValue="branch" cssClass="selectstyle form-control">
                                           </s:select>
					  </div>
					</form>
                        <br />
