...
function Product(retailer, name, desc, price, initialSet) {
 var self = this;
 self.retailer = retailer;
 self.name = name;
 self.desc = desc;
 self.price = price;
 self.set = ko.observableArray(initialSet);
...
function ContentViewModel() {
 ...
 self.availableSet = [{
     ...
     setName: "Back to School"
 }, {
     setName: "Superbowl"
 }];

 // Table Headers View Model
 self.headers = [{
     title: 'Retailer',
     sortPropertyName: 'retailer',
     asc: true
 }, {
     title: 'Name',
 ...
 new Product("Edwin Watts", "Driver", "Heres a sweet description of the driver", "19.99 USD", [self.availableSet[0], self.availableSet[1]]),
 new Product("Art.com", "Circus Poster", "Circus' aren't scary!", "229.99 USD", [self.availableSet[0]]),
 new Product("Reebok", "Bouncy Shoe", "Shoes are awesome, shoes are great", "49.99 USD", [self.availableSet[1]]),
 new Product("Reebok", "Bouncy Shoe", "Shoes are awesome, shoes are great", "49.99 USD", []),
