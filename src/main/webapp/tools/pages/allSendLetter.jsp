...
<div class="col-lg-12 col-md-12">
	<div class="input-group">
		<input type="text" name="searchText" id="searchTextLetter"
			placeholder="Search by first,last name,mob no.,postcode" class="form-control">
			 <span class="input-group-btn">
			<button class="btn btn-primary" type="button"
				onclick="searchTemplatePatientLetter()">Go!</button>
		</span>
	</div>
	<!-- /input-group -->
</div>
...
<input type="hidden" id="userLetter" name="user">
<input type="hidden" id="id" name="id">
<div class="row">
	<div class="col-lg-12">
		<div class="table-responsive">
			<table id="allSendLetters"
