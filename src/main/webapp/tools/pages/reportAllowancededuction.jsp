...
<div class="container-fluid" style="background-color: #efefef;"><a>
<h4><strong>Allowance Deduction</strong> Report</h4>
</a></div>
...
<table class="table my-table xlstable table-bordered table-responsive" style="width: 100%;">
	<thead>
		<tr>
			<th>Sr.No</th>
			<th>Name</th>
