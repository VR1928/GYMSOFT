...
<div class="row details mainheader">
								...
								<h4>Edit Dietary Details</h4>
								</div>
							</div>

<s:form action="updateDietarydetails" theme="simple">
<div class="row">
	...
	<div class="col-lg-6 col-md-8">
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<label>Sodium</label><label class="text-danger">*</label>
				<s:textfield id="sodium" name="sodium"
					cssClass="showToolTip form-control" data-toggle="tooltip"
					title="Enter sodium" placeholder="Enter sodium"/>
				<label>Potassium</label><label class="text-danger">*</label>
				<s:textfield id="potassium" name="potassium"
					cssClass="showToolTip form-control" data-toggle="tooltip"
					title="Enter potassium" placeholder="Enter potassium"/>		
			</div>
		</div>
	</div>
	<div class="col-lg-3 col-md-2"></div>
