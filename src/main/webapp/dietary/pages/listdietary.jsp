...
<div class="col-lg-12 col-md-12 topback2">
	...
	<div class="col-lg-6 col-md-8">
		<!--<a class="btn btn-primary" href="#" onclick="calladd()" style="margin-top:21px;"><i
			...
			<a class="btn btn-primary" href="addDietary" style="margin-top:21px;"><i
			class="fa fa-plus"></i> Add</a>
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="listdietary!=null">
						<s:iterator value="listdietary" status="rowstatus">
								<tr>
								...
								<td class="text-center"><a href="editDietary?id=<s:property value="id"/>" class="text-primary">
										<i class="fa fa-edit"></i>
									</a>
								</td>
								<td class="text-center"><a href="delDietary?id=<s:property value="id"/>" onclick="return myfunction()" class="text-danger">
