...
<div class="">
                    <div class="col-lg-12 col-md-12 col-sm-12 topback2">
                        <div class="col-md-9 martop6">
                            <form class="form-inline">
                            <div class="form-group titlepadright">
                                    <label for="exampleInputEmail3">Main Dashboard <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></label>
                                </div>
                        ...
                        <span style="font-size: 17px;color: green;">"Lets go green to get our globe clean"</span>
                        </div>
                    </div> 
                    <div class="row">
