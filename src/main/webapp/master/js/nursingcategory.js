...
function addRow(tableID) {
	...
	cell3.innerHTML = "<input type='text' maxlength='50' placeholder='Enter Name'   class='form-control showToolTip filedname' name = 'nursing_category["
			+ counts + "].name'>";

	var cell4=row.insertCell(3);
	cell4.innerHTML = "<input type='text' maxlength='50' placeholder='Enter Description'   class='form-control showToolTip' name = 'nursing_category["
		+ counts + "].description'>";
