...
<title>Add Nursing Diagnosis </title>
...
<s:form action="saveNursingPlan" id="master_form" theme="simple">
<div class="row">
	...
	<div class="row">
		<div class="col-lg-3 col-md-2"></div>
		<div class="col-lg-6 col-md-8">
			<s:submit cssClass="btn btn-primary" value="Save" onclick="return saveNursingPlan()" />
