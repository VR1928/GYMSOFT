...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addProductTypeMaster')"><i
	...
	<s:form action="ProductTypeMaster">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Product Type"  cssClass="form-control" />
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="productypelist!=null">
						<s:iterator value="productypelist" status="rowstatus">
								<tr>
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editProductTypeMaster?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteProductTypeMaster?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
...
<s:form action="ProductTypeMaster" name="paginationForm" id="paginationForm" theme="simple">
