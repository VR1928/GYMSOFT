...
<div class="row details mainheader">
								...
								<h4>Edit NursingCare Intervention</h4>
								</div>
							</div>

<s:form action="updateNursingCareIntervention" id="master_form" theme="simple">
<div class="panel panel-primary">
							...
							<table class="table table-striped table-hover table-condensed"  width="100%" >
								...
								<tbody>
									<tr>
									 ...
									 <td><input type="text" name="nursing_intervention" placeholder="enter intervention name" value='<s:property value="nursing_intervention"/>' id="nursing_intervention" class="form-control showToolTip filedname" data-toggle="tooltip"/></td> 	
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-8">
			<s:submit cssClass="btn btn-primary" value="Update" onclick="updateNursingCareIntervention" />
