							...
							<div class="">
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										<h4>All Medicine Template List</h4>
									</div>
								</div>
								<div class="row ">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
			...
			<table id="results"
				...
				<%int i=0; %>
						...
						<s:iterator value="templatelist" status="rowstatus">
								...
								<td class="text-center"><s:property value="templatename" /></td>
								...
								<td class="text-center"><a href="#" onclick="opencPopup('')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteMedicineTemplateMaster?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
