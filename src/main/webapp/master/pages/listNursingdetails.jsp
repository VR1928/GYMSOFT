...
<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addNursingdetails')"><i
...
<s:form action="Nursingdetails">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Task Name"  cssClass="form-control" />
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="addNursingdetails" style="margin-top:21px;"><i
			class="fa fa-plus"></i> Add</a>
	</div>
			...
			<table id="results"
				...
				<thead>
					<tr>
						...
						<th class="text-left">Nursing Category</th>
				...
				<tbody>
					<s:if test="nursingdetails.size!=0">
						<s:iterator value="nursingdetails" status="rowstatus">
							<tr>
								<td><s:property value="id" /></td>
								<td><s:property value="nursingtype" /></td>
								<td><s:property value="taskname" /></td>
								<td><s:property value="frequency" /></td>                
								<td><s:property value="notes" /></td>
								<s:hidden value="%{id}" name="id"></s:hidden>
								<s:url action="editNursingdetails" id="edit">
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editNursingdetails?selectedid=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<s:url action="deleteNursingdetails" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
				...
				<s:else>
						There is no Nursing Details List found!!
					</s:else>
			</table>
		</div>
	</div>
...
<s:form action="Nursingetails" name="paginationForm" id="paginationForm" theme="simple">
