...
<s:form action="saveMaster" id="master_form" theme="simple">
<div class="row">
		...
		<div class="panel panel-primary">
			<div class="panel-body">
			    ...
			    <s:select list="booklist" headerKey="0" headerValue="Seletc Book" id="book" name="id" listKey="id" listValue="name"  cssClass="form-control"></s:select>			   
					...
					<label>Enter Discriptionk</label><label class="text-danger">*</label>
	...
	<div class="row">
		<div class="col-lg-3 col-md-2"></div>
		<div class="col-lg-6 col-md-8">
			<s:submit cssClass="btn btn-primary" value="Save" onclick="return savestate1()" />
