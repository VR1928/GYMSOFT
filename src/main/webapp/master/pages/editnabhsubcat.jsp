...
<div class="row details mainheader">
								...
								<h4>Edit NABH Sub Category</h4>
								</div>
							</div>

<s:form action="updateNABHSubCatagoryMaster" theme="simple">
<div class="row">
	...
	<div class="col-lg-6 col-md-8">
		<div class="panel panel-primary">
			<div class="panel-body">
			    ...
			    <s:select list="nabhcatagorylist" id="catagoryid" headerKey="0" headerValue="Seletc Category" name="catagoryid" listKey="id" listValue="name" cssClass="form-control"></s:select>			   
	...
	<div class="row">
		<div class="col-lg-3 col-md-2"></div>
		<div class="col-lg-6 col-md-8">
			<s:submit cssClass="btn btn-primary" value="update" onclick="return savenabhsubcat()"/>
