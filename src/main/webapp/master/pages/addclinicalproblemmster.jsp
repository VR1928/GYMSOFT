...
<div class="row details">
			...
			<a class="btn btn-primary" href="#" onclick="opencPopup('addclinicalnotesmstrMaster')"><i
				class="fa fa-plus"></i> Add</a>
								...
								<s:form action="saveclinicalproblemmstrMaster">
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
				...
				<%-- <s:textfield id="name" name="name"
					...
					<input type="text" name="name" class="showToolTip form-control" placeholder="clinical problem name" required>
					</div>
