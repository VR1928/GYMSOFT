...
<div class="row">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			<li><a href="Expencecategory">All Expense Category</a></li>
...
<s:form action="saveExpencecategory" id="master_form" theme="simple">
<div class="row">
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-8">
			...
			<a href="Expencecategory" class="btn btn-primary">Back</a>
		</div>
		<div class="col-lg-3 col-md-2"></div>
	</div>
	<s:token></s:token>
