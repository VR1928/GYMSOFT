							...
							<div class="">
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										<h4>All Nursing Diagnosis List</h4>
									</div>
								</div>
								<div class="row ">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addNursingPlan')"><i
		...
		<div class="">
			<table id="results"
				...
				<tbody>
						...
						<s:iterator value="nursingdiagnosislist" status="rowstatus">
								<tr>
								<td class="text-center"><s:property value="id" /></td>
								<td class="text-center"><s:property value="nursing_diagnosis" /></td>
								
								
								<td class="text-center"><a href="#" onclick="opencPopup('editNursingPlan?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteNursingPlan?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
...
<s:form action="NursingPlan" name="paginationForm" id="paginationForm" theme="simple">
