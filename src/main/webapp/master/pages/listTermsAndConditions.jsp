							...
							<div class="">
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										...
										<h4>All Terms and Condition List</h4>
...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2 hidden">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addTermsConditionMaster')"><i
	...
	<s:form action="TermsConditionMaster">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Terms Condition name "  cssClass="form-control" />
			...
			<table id="results"
				...
				<thead>
					<tr>
						...
						<th class="text-center">Terms and condition Name</th>
				...
				<tbody>
					<s:if test="termConditionList!=null">
						<s:iterator value="termConditionList" status="rowstatus">
								<tr>
								<td class="text-center"><s:property value="id" /></td>
								<td class="text-center"><s:property value="name" /></td>
							
								<td class="text-center"><a href="#" onclick="opencPopup('editTermsConditionMaster?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteTermsConditionMaster?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
				...
				<s:else>
						There is no Term and Condition List found!!
					</s:else>
			</table>
		</div>
	</div>
...
<s:form action="TermsConditionMaster" name="paginationForm" id="paginationForm" theme="simple">
