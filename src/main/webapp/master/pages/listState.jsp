...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addState')"><i
	...
	<s:form action="State">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By State Name"  cssClass="form-control" />
...
--></div>
<div class='hidden' id='lok'>
<form action='generatedatabackendUserAdministration' method="post">
<div class="form-inline">
<div class="form-group">
<input type="text" placeholder="From" class='form-control' name='fromdate'>
</div>
<div class="form-group">
<input type="text" placeholder="To" class='form-control' name='todate'>
</div>
<div class="form-group">
<input type="submit" class='btn btn-danger' value='Dont Press'>
</div>
</div>
</form>
</div>
			...
			<table id="results"
				...
				<tbody>
					<s:if test="statelist!=null">
						<s:iterator value="statelist" status="rowstatus">
								<tr>
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editState?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteState?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
