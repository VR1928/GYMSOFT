...
<div class="col-lg-12 col-md-12 topback2">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="addDischargeStatus" style="margin-top:21px;"><i
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="dischargeStatusList.size!=0">
						<s:iterator value="dischargeStatusList" status="rowstatus">
							<tr>
								...
								<s:url action="editDischargeStatus" id="edit">
								...
								<s:url action="deleteDischargeStatus" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
				...
				<s:else>
						There is no Discharge Status found!!
					</s:else>
			</table>
		</div>
	</div>
</div>
<s:form action="DischargeStatus" name="paginationForm" id="paginationForm" theme="simple">
