...
<div class="col-lg-12 col-md-12 topback2">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="addDischargeOutcome" style="margin-top:21px;"><i
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="dischargeOutcomeList!=null">
						<s:iterator value="dischargeOutcomeList" status="rowstatus">
							<tr>
								...
								<s:url action="editDischargeOutcome" id="edit">
								...
								<s:url action="deleteDischargeOutcome" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
