...
<s:form action="updateDeclaration" id="declaration_form" theme="simple">
<div class="row">
		...
		<div class="panel panel-primary" style="width: 850px;height: 637px;">
			<div class="panel-body">
				...
				<textarea style="height: 250px;" rows="10" cols="10" id="declarationNotes" name="declarationNotes"
					...
					title="Enter Declaration" placeholder="Enter Declaration"><%=(String)session.getAttribute("declarationNotes").toString()%></textarea>
			</div>
		</div>
	</div>
	<div class="col-lg-3 col-md-2"></div>
