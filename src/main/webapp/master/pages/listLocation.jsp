...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addLocationMaster')"><i
	...
	<s:form action="LocationMaster">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Location"  cssClass="form-control" />
...
<div class="row">
			...
			<table id="results"
				...
				<tbody>
					<s:if test="locationList.size>0">
						<s:iterator value="locationList" status="rowstatus">
								<tr>
								<td class="text-center"><s:property value="id" /></td>
								<td class="text-center"><s:property value="name" /></td>
								<td class="text-center"><a href="#" onclick="opencPopup('editLocationMaster?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteLocationMaster?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
 ...
 <s:form action="LocationMaster" name="paginationForm" id="paginationForm"
	theme="simple">
