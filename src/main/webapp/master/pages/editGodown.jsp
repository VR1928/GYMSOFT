...
<div class="row">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			<li><a href="/APM/categoriesProductinventory">All Godown List</a></li>
			<li class="active">Update Godown</li>
		</ol>
	</div>
</div>
...
<s:form action="updateGodown" id="master_form" theme="simple">
<div class="row">
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-8">
			...
			<a href="Godown" class="btn btn-primary">Back</a>
		</div>
		<div class="col-lg-3 col-md-2"></div>
	</div>
</s:form>
