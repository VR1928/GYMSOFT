...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addDeclaration')"><i
...
<s:form action="Declaration">	
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="addDeclaration" style="margin-top:21px;"><i
			class="fa fa-plus"></i> Add</a>
	</div>
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
				<s:if test="declarationList.size!=0">
				<s:iterator value="declarationList">
					<tr>
						<td><s:property  value="title"></s:property></td>
						<td class="text-center"><a href="#"
										onclick="opencPopup('editDeclaration?selectedid=<s:property  value="id"/>')" class="text-warning" style="width: 5%;">
										<i class="fa fa-edit text-info"></i>
									</a></td>		
						<td class="text-center"><a href="deleteDeclaration?selectedid=<s:property  value="id"></s:property>"
...
<s:form action="Declaration" name="paginationForm" id="paginationForm" theme="simple">
