...
<div class="row">
	<div class="col-lg-12" align="center">
		<ol class="breadcrumb">
			<li><a href="OtherTemplate">Update Terms Condition </a></li>
...
<s:form action="updateTermsConditionMaster" id="master_form" theme="simple" onsubmit="return validateInvSection()">
<div class="row">
		...
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<s:textfield id="name" name="name"
					...
					title="Enter Terms Condition Name" placeholder="Enter Terms Condition" onkeyup="initialCap(this)"/>
