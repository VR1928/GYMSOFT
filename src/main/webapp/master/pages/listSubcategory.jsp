...
<div class="col-lg-12 col-md-12 topback2">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="#" style="margin-top:21px;" onclick="opencPopup('addsubcategoryProductinventory')"><i
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="subcategoryList!=null">
						<s:iterator value="subcategoryList" status="rowstatus">
								...
								<td class="text-center"><a href="editsubcategoryProductinventory?id=<s:property value="id"/>" class="text-primary">
										<i class="fa fa-edit"></i>
									</a>
								</td>
								<td class="text-center"><a href="deletesubcategoryProductinventory?id=<s:property value="id"/>"
...
<s:form action="listsubcategoriesProductinventory" name="paginationForm" id="paginationForm" theme="simple">
