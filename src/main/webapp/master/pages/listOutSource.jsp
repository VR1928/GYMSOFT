...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addOutSourceMaster')"><i
		...
		<div class="">
			<table id="results"
				...
				<tbody>
						...
						<s:iterator value="outsourcelist" status="rowstatus">
								<tr>
								<td class="text-center"><s:property value="outsource_id" /></td>
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editOutSourceMaster?id=<s:property value="outsource_id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteOutSourceMaster?id=<s:property value="outsource_id"/>" onclick="return ConfirmDelete()" class="text-danger">
