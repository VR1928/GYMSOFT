...
<div class="col-lg-12 col-md-12 topback2">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="#" style="margin-top:21px;" onclick="opencPopup('addEvents')"><i
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<thead>
					<tr>
						<th class="text-left" style="width: 4%;">Sr No</th>
						<th class="text-left" style="width: 11%;">Event Name</th>
				...
				<tbody>
					<s:if test="eventList.size!=0">
						<s:iterator value="eventList" status="rowstatus">
							<tr>
								...
								<s:url action="editEvents" id="edit">
								...
								<s:url action="deleteEvents" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
				...
				<s:else>
						There is no Event List found!!
					</s:else>
			</table>
		</div>
	</div>
</div>
<s:form action="Events" name="paginationForm" id="paginationForm" theme="simple">
