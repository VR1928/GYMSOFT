...
<div class="col-lg-12 col-md-12 topback2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addPrescriptioncategory')"><i
...
<s:form action="Prescriptioncategory">	
		<div class="col-lg-3 col-md-2">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="addPrescriptioncategory" style="margin-top:21px;"><i
			class="fa fa-plus"></i> Add</a>
	</div>
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="prescriptioncategorylist.size!=0">
						<s:iterator value="prescriptioncategorylist" status="rowstatus">
							<tr>
								<td><s:property value="id" /></td>
								<td><s:property value="name"/></td>
                                <td><s:property value="description"/></td>
								<s:hidden value="%{id}" name="id"></s:hidden>
								<!--<s:url action="editPrescriptioncategory" id="edit">
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editPrescriptioncategory?selectedid=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<s:url action="deletePrescriptioncategory" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
				...
				<s:else>
						There is no Prescription Category List found!!
					</s:else>
			</table>
		</div>
	</div>
</div>
<s:form action="Prescriptioncategory" name="paginationForm" id="paginationForm" theme="simple">
