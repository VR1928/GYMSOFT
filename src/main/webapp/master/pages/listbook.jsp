...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addBook')"><i
			...
			<table id="results"
				...
				<tbody>
					<s:if test="booklist!=null">
						<s:iterator value="booklist" status="rowstatus">
								<tr>
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editBook?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteBook?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
