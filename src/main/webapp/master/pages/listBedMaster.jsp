...
<div class="col-lg-12 col-md-12 topback2">
	...
	<s:form action="bedlistmasterBed">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Bed Name"  cssClass="form-control" />
		</div>
		<div class="col-lg-1 col-md-1">
			...
			<table id="results"
				...
				<thead>
					<tr>
						...
						<th class="text-center">BedName</th>
						<th class="text-center">Edit</th>
						<th class="text-center">Delete</th>
					</tr>
				</thead>
				<tbody>
					<s:if test="bedlist!=null">
						<s:iterator value="bedlist" status="rowstatus">
								<tr>
								...
								<td class="text-center"><s:property value="bedname"/></td>
								<!--<td class="text-center"><a href="#" onclick="editbedmasterBed?selectedid=<s:property value="id"/>" class="text-warning">
										<i class="fa fa-edit"></i>
									</a>
								</td>-->
								<td class="text-center"><a href="#" onclick="opencPopup('editbedmasterBed?selectedid=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center">
									<s:if test="status==0">
										<a href="deletebedmasterBed?selectedid=<s:property value="id"/>"
				...
				<s:else>
						There is no Bed List found!!
					</s:else>
			</table>
		</div>
	</div>
</div>
<s:form action="bedlistmasterBed" name="paginationForm" id="paginationForm" theme="simple">
