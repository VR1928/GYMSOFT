...
<div class="row">
	<div class="col-lg-12" align="center">
		<ol class="breadcrumb">
			<li><a href="OtherTemplate">Add Terms And Condition </a></li>
...
<s:form action="saveTermsConditionMaster" id="master_form" theme="simple" onsubmit="return validateTermSection()" >
<div class="row">
	...
	<div class="col-lg-6 col-md-8">
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<label>Terms Condition Name</label><label class="text-danger">*</label>
				<s:textfield id="name" name="name"
					cssClass="showToolTip form-control" data-toggle="tooltip"
					title="Enter TermsCondition Name" placeholder="Enter TermsCondition Name" onkeyup="initialCap(this)"/>
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-8">
			...
			<a href="TermsConditionMaster" class="btn btn-primary">Back</a>
		</div>
		<div class="col-lg-3 col-md-2"></div>
	</div>
	<s:token></s:token>
