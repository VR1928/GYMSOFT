...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addNursingcategory')"><i
	...
	<s:form action="Nursingcategory">	
		<div class="col-lg-3 col-md-2 hidden">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Catagory name"  cssClass="form-control" />
		</div>
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="nursingcategorylist!=null">
						<s:iterator value="nursingcategorylist" status="rowstatus">
								<tr>
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editNursingcategory?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteNursingcategory?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
