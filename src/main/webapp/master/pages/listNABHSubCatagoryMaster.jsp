...
<h4>All NABH Sub Category List</h4>
...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addNABHSubCatagoryMaster')"><i
	...
	<s:form action="NABHSubCatagoryMaster">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Sub Category Name"  cssClass="form-control" />
...
<table id="results"
	...
	<tbody>
		<s:if test="nabhsubcatagorylist!=null">
			<s:iterator value="nabhsubcatagorylist" status="rowstatus">
				<tr>
					<td class="text-center"><s:property value="id" /></td>
					<td class="text-center"><s:property value="categoryname" /></td>
					<td class="text-left"><s:property value="name" /></td>
					<td class="text-center"><a href="editNABHSubCatagoryMaster?id=<s:property value="id"/>"> <i class="fa fa-edit"></i> </a></td>
					<td class="text-center"><a href="deleteNABHSubCatagoryMaster?id=<s:property value="id"/>"
...
<s:form action="NABHSubCatagoryMaster" name="paginationForm" id="paginationForm"
	theme="simple">
