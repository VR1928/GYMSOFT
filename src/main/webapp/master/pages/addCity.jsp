...
<s:form action="saveCityMaster" id="master_form" theme="simple">
<div class="row">
	...
	<div class="col-lg-6 col-md-8">
		<div class="panel panel-primary">
			<div class="panel-body">
			    ...
			    <s:select list="statelist" headerKey="0" headerValue="Seletc state" id="stateid" name="stateid" listKey="id" listValue="name"  cssClass="form-control"></s:select>			   
	...
	<div class="row">
		<div class="col-lg-3 col-md-2"></div>
		<div class="col-lg-6 col-md-8">
			<s:submit cssClass="btn btn-primary" value="Save" onclick="return savecity()"/>
