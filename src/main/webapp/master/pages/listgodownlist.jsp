...
<div class="col-lg-12 col-md-12 topback2">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="#" style="margin-top:21px;" onclick="opencPopup('addGodown')"><i
			...
			<table id="results"
				...
				<s:else>
					<h3 class="text-center">
						<i class="fa fa-times text-danger"></i> There is Godown list found!!
					</h3>
...
<s:form action="Godown" name="paginationForm" id="paginationForm" theme="simple">
