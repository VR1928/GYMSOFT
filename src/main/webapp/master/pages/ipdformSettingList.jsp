							...
							<div class="">
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										...
										<h4>Ipd Form Department Setting List</h4>
...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addIpdformsetting')"><i
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
				   <%int i=0; %>
					<s:if test="ipdformsettingList.size!=0">
						<s:iterator value="ipdformsettingList" status="rowstatus">
							<tr>
								<td> <%=(++i)%> </td>
                                <td><s:property value="specialization" /></td>
                                <td><s:property value="fields" /></td>
                                         
								<s:hidden value="%{dept_id}" name="id"></s:hidden>
								
								<td class="text-center"><a href="#" onclick="opencPopup('editIpdformsetting?selectedid=<s:property value="dept_id"/>')"><i class="fa fa-edit"></i></a></td>
								<s:url action="deleteIpdformsetting" id="delete">
									<s:param name="selectedid" value="%{dept_id}"></s:param>
								</s:url>
				...
				<s:else>
						There is no Ipd Form Department Setting List found!!
					</s:else>
			</table>
		</div>
	</div>
...
<!--<s:form action="InvestigationNameMaster" name="paginationForm" id="paginationForm"
	theme="simple">
