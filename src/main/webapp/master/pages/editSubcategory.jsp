...
<s:form action="updatesubcategoryProductinventory" id="master_form" theme="simple" onsubmit="return validteStripCheck()">
<div class="row">
		...
		<div class="panel panel-primary">
			...
			<s:hidden id="id" name="id" />
				...
				<s:textfield id="description" name="description"
                 ...
                 <input class="case" type="checkbox" checked="checked"/> 
             </s:if>
             <s:else>
                <input class="case" type="checkbox" /> 
             </s:else>
               <s:hidden name="stripcheck" id="stripcheck"></s:hidden>
			</div>
		</div>
	</div>
	<div class="col-lg-3 col-md-2"></div>
