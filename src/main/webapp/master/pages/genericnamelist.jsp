...
<div class="col-lg-12 col-md-12 topback2">
	<%-- <div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addgenericnameMaster')"><i
				class="fa fa-plus"></i> Add</a>
		</div>
		<div class="col-lg-3 col-md-2">
			<s:select list="masterlist"
					cssClass="form-control showToolTip chosen-select hidden" name="mastername"
					listKey="id" listValue="name" onchange="selectAction(this.value)"></s:select>
		</div>
		<div class="col-lg-3 col-md-2">
		</div> 
	...
	<s:form action="genericnameMaster">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Generic Name"  cssClass="form-control" />
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="genericnamelist!=null">
						<s:iterator value="genericnamelist" status="rowstatus">
								<tr>
								<td class="text-center"><s:property value="id" /></td>
								<td class="text-center"><s:property value="name" /></td>
								<%-- <td class="text-center"><a href="#" onclick="opencPopup('editgenericnameMaster?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deletegenericnameMaster?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
...
<s:form action="genericnameMaster" name="paginationForm" id="paginationForm" theme="simple">
