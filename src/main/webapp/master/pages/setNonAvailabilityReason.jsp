...
<div class="col-lg-12 col-md-12 topback2">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="#" style="margin-top:21px;" onclick="opencPopup('addNotAvailableReason')"><i
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<thead>
					<tr>
						<th><a href="#" onclick="fnPagination(6,'occupation');" style="color:#fff;">Name</a></th>
				...
				<tbody>
					<s:if test="notAvailableReasonList!=null">
						<s:iterator value="notAvailableReasonList" status="rowstatus">
							<tr>
								...
								<s:url action="editNotAvailableReason" id="edit">
								...
								<s:url action="deleteNotAvailableReason" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
				...
				<s:else>
						There is no NotAvailableReason found!!
					</s:else>
			</table>
		</div>
	</div>
</div>							
<s:form action="NotAvailableReason" name="paginationForm" id="paginationForm" theme="simple">
