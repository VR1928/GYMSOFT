...
<s:form action="updateEvents" id="eventsupdateform" theme="simple">
<div class="row">
...
<div>
  ...
  <div class="form-group">
     ...
     <s:select id="ampm" list="#{'am':'am','pm':'pm'}" name="ampm" cssClass="form-control">
	 </s:select>
  </div>
</div>
  </div>
  ...
  <div class="row">
		<div class="col-lg-12 col-md-12">
			<input type="button" class="btn btn-primary" value="Update" onclick="updateData()" />
