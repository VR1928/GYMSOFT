...
<s:form action="DiagnosisProblem">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Diagnosis Problem"  cssClass="form-control" />
		</div>
		<div class="col-lg-1 col-md-1">
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="problemlist!=null">
						<s:iterator value="problemlist" status="problemlist">
							<tr>
								...
								<s:url action="editDiagnosisProblem" id="edit">
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editDiagnosisProblem?selectedid=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								
								<s:url action="deleteDiagnosisProblem" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
				...
				<s:else>
						There is no Diagnosis Problem List found!!
					</s:else>
			</table>
		</div>
	</div>
</div>
<s:form action="DiagnosisProblem" name="paginationForm" id="paginationForm" theme="simple">
