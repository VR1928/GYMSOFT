...
<div class="col-lg-12 col-md-12 topback2">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="#" style="margin-top:21px;" onclick="opencPopup('addExpencecategory')"><i
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="expececategorylist.size!=0">
						<s:iterator value="expececategorylist" status="rowstatus">
							<tr>
								<td><s:property value="id" /></td>
								<td><s:property value="name" /></td>
								<td><s:property value="description" /></td>
								<s:hidden value="%{id}" name="id"></s:hidden>
								<s:url action="editExpencecategory" id="edit">
								...
								<s:url action="deleteExpencecategory" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
				...
				<s:else>
						There is no Expense Category List found!!
					</s:else>
			</table>
		</div>
	</div>
...
<s:form action="Expencecategory" name="paginationForm" id="paginationForm" theme="simple">
