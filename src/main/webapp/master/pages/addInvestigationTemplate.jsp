...
<div class="row details mainheader">
								...
								<h4>Add Investigation Template</h4>
								</div>
							</div>
<div class="row">
	<div class="col-lg-12">
...
<s:form action="saveInvestigationTemplate" id="master_form" theme="simple">
<div class="row">
		...
		<div class="panel panel-primary">
			...
			<div class="col-lg-12 col-xs-12 col-sm-12">
				...
				<div class="form-group">
					...
					title="Enter Ipd Template Text" placeholder="Enter Investigation Template Text" ></textarea>
						</div>
