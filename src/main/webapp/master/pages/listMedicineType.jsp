...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addMedicineTypeMaster')"><i
	...
	<s:form action="MedicineTypeMaster">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Medicine Type"  cssClass="form-control" />
			...
			<table id="results"
				...
				<thead>
					<tr>
						...
						<th class="text-center">Isstrip</th>
						<th class="text-center">Edit</th>
						<th class="text-center">Delete</th>
					</tr>
				</thead>
				<tbody>
					<s:if test="medicinetypelist!=null">
						<s:iterator value="medicinetypelist" status="rowstatus">
								<tr>
								<td class="text-center"><s:property value="id" /></td>
								<td class="text-center"><s:property value="name" /></td>
								<td class="text-center"><s:property value="isstrip" /></td>
								<!--<td class="text-center"><a href="editState?id=<s:property value="id"/>" class="text-primary">
										<i class="fa fa-edit"></i>
									</a>
								</td>
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editMedicineTypeMaster?id=<s:property value="id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteMedicineTypeMaster?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
...
<s:form action="MedicineTypeMaster" name="paginationForm" id="paginationForm" theme="simple">
