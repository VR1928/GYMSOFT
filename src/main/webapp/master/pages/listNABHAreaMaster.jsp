...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addNABHAreaMaster')"><i
	...
	<s:form action="NABHAreaMaster">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Area Name"  cssClass="form-control" />
...
<table id="results"
	...
	<tbody>
		<s:if test="arealist!=null">
			<s:iterator value="arealist" status="rowstatus">
				<tr>
					<td class="text-center"><s:property value="id" /></td>
					<td class="text-center"><s:property value="subcategoryname" /></td>
					<td class="text-left"><s:property value="name" /></td>
					<td class="text-center"><a href="editNABHAreaMaster?id=<s:property value="id"/>"> <i class="fa fa-edit"></i> </a></td>
					<td class="text-center"><a href="deleteNABHAreaMaster?id=<s:property value="id"/>"
...
<s:form action="NABHAreaMaster" name="paginationForm" id="paginationForm"
	theme="simple">
