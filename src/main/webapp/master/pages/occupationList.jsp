...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addOccupation')"><i
...
<s:form action="Occupation">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Occupation"  cssClass="form-control" />
		</div>
		<div class="col-lg-1 col-md-1">
	...
	<div class="col-lg-6 col-md-8">
		<a class="btn btn-primary" href="addOccupation" style="margin-top:21px;"><i
			class="fa fa-plus"></i> Add</a>
	</div>
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<thead>
					<tr>
						<th class="text-center sortable <s:if test="#attr.pagination.sortColumn.equals('occupation')">sorted <s:property value="#attr.pagination.sortClass"/> </s:if>">
						<a href="#" onclick="fnPagination(6,'occupation');">Name</a></th>
					...
					<s:if test="occupationList.size!=0">
						<s:iterator value="occupationList" status="rowstatus">
							<tr>
								...
								<s:url action="editOccupation" id="edit">
								...
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editOccupation?selectedid=<s:property value="id"/>')"><i class="fa fa-edit"></i></a></td>
								<s:url action="deleteOccupation" id="delete">
									<s:param name="selectedid" value="%{id}"></s:param>
								</s:url>
...
<s:form action="Occupation" name="paginationForm" id="paginationForm" theme="simple">
