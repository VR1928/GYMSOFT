...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addMaster')"><i
	...
	<s:form action="showallbookChapterMaster">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Chapter Name"  cssClass="form-control" />
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="bookChapterlist!=null">
						<s:iterator value="bookChapterlist" status="rowstatus">
								<tr>
								<td class="text-center"><s:property value="book_chapter_id" /></td>
								<td class="text-center"><s:property value="book_chapter_name" /></td>
								<td class="text-center"><s:property value="book_chapter_link" /></td>
								<td class="text-center"><s:property value="book_chapter_discription" /></td>
								<!--<td class="text-center"><a href="editState?id=<s:property value="id"/>" class="text-primary">
										<i class="fa fa-edit"></i>
									</a>
								</td>
								-->
								<td class="text-center"><a href="#" onclick="opencPopup('editMaster?id=<s:property value="book_chapter_id" />')"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteMaster?id=<s:property value="book_chapter_id"/>" onclick="return ConfirmDelete()" class="text-danger">
