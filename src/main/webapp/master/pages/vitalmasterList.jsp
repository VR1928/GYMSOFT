...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addVitalmaster')"><i
	...
	<div class="col-lg-12">
		<div class="">
			<table id="results"
				...
				<tbody>
					<s:if test="vitalMasterList!=null">
						<s:iterator value="vitalMasterList" status="rowstatus">
								<tr>
								<td class="text-center"><s:property value="id" /></td>
								<td class="text-center"><s:property value="name" /></td>
								<td class="text-center"><s:property value="vital_type_name" /></td>
								<!--<td class="text-center"><a href="editState?id=<s:property value="id"/>" class="text-primary">
										<i class="fa fa-edit"></i>
									</a>
								</td>
								-->
								<td class="text-center"><a href="editVitalmaster?id=<s:property value="id"/>"><i class="fa fa-edit"></i></a></td>
								<td class="text-center"><a href="deleteVitalmaster?id=<s:property value="id"/>" onclick="return ConfirmDelete()" class="text-danger">
				...
				<s:else>
						There is no Vital Master List found!!
					</s:else>
			</table>
		</div>
	</div>
...
<s:form action="Vitalmaster" name="paginationForm" id="paginationForm" theme="simple">
