...
<div class="row">
	<div class="col-lg-12" align="center">
		<ol class="breadcrumb">
			<li><a href="OtherTemplate">Update Investigation Section </a></li>
...
<s:form action="updateInvestigationSectionMaster" id="master_form" theme="simple" onsubmit="return validateInvSection()">
<div class="row">
	...
	<div class="col-lg-6 col-md-8">
		<div class="panel panel-primary">
			<div class="panel-body">
			    ...
			    <label>Select Department</label><label class="text-danger">*</label>
			    <s:select list="jobTitleList"  headerKey="0" headerValue="Select Department" name="jobtitle" cssClass="form-control"></s:select>			   
