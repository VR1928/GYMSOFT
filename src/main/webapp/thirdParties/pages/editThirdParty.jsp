		...
		<ol class="breadcrumb">
			<li><a href = "#">Third Parties</a></li>
				<li ><a href = "/APM/ThirdParty">All Third Party List</a></li>
					<li class="active">Update Third Party Details</li>
		</ol>
	</div>
</div>
...
<s:form action="updateDetailsThirdParty" theme="simple" >
...
`				<div class="row">
			...
			<div class="form-group">			
				<label>Contact Name/GP Name</label>
		 	...
		 	<s:textfield id = "gpaddress" name = "gpaddress" theme="simple" cssClass="form-control showToolTip" data-toggle = "tooltip" placeholder = "Enter Town" title="Enter Town"/>
		 	</div>
		 	<div class="form-group">	
		 	<label>Town</label>
		 	...
		 	<div class="form-group">	
		 	<label>Direct Telephone Line</label>
...
`				<div class="row">
		 	...
		 	<div class="form-group">
		 			...
		 			<a class="previous btn btn-primary"
									data-target-div="#companyDetails" data-target-tab="#CDTab"><i
									class="fa fa-reply"></i> Previous</a>
...
`				<div class="row">
		 	...
		 	<a class="previous btn btn-primary"
									...
									class="fa fa-reply"></i> Previous</a>
		 		<s:submit value="Update" cssClass="btn btn-primary" onclick = "return validateCP()"/>
		 		</div>
		 		</div>
		 </div>
		</div>
...
<s:submit value="Update" cssClass="btn btn-primary" onclick = "return validateCP()" theme="simple"/>
