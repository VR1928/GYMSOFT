...
<div class="">
							<div class="">
								...
								<div class="row ">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										<div>
										<s:form action="updateGP" id="gp_form" theme="simple">		
											<div class="row">
												...
												<div class="col-lg-4 col-md-4">
													...
													<div class="panel-body">			
														<div class="row">
															...
															<div class="panel-body">
																<label>Work Phone Number</label><label><span class="text-danger">*</span></label>
															...
															<div class="panel-body">
																<label>Email</label><label><span class="text-danger">*</span></label>
