...
<div class="row">
	...
	<div class="row marboth">
		...
		<div class="col-lg-2 col-xs-2 col-md-2">
			<s:textfield theme="simple" id="date" name="date" placeholder="Select Date" cssClass="form-control" ></s:textfield>
		</div>
	</div>	
...
<div class="">
	...
	<table class="table table-bordered widthdebicha" cellspacing="0">
									...
									<input id="addchargebtn" type="button" value="Add Charge" onclick="getInventoryProductStock()" disabled="disabled" class="btn btn-primary" style="float:right;">
									</div>
									</div>
...
<table class="table table-bordered widthdebicha" cellspacing="0">
										<thead>
											...
											<th style="width: 9%;">Paid By</th>
												<th class="chartype" style="width: 28%;">Charge Type</th>
