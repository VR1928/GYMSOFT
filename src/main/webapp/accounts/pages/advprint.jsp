<%@page import="com.apm.Accounts.eu.blogic.jdbc.JDBCAdditionalDAO"%>
<%@page import="com.apm.Accounts.eu.bi.AdditionalDAO"%>
				...
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding-left:0px;padding-right:0px;">
						...
						<div class="col-lg-4 col-md-4 col-xs-4">
							<div class="form-group" style="margin-bottom: 0px !important;text-align: center;">
								<b class="setticolors">ADVANCE RECEIPT</b>
						</div>
						</div>
...
<script>
	...
	document.write(hours + ":" + minutes + " " + suffix)
				...
				<div class="form-group" style="margin-bottom: 3px;">
					<label for="inputEmail3" class="control-label">Mother Name</label><span>: <s:property value="mothername"/> </span>
				</div>
				</s:if>
			...
			<div class="col-lg-5 col-md-5 col-xs-6 col-sm-6 text-right" style="padding-left:0px;padding-right:0px;">
				<div class="form-group" style="margin-bottom: 3px;">
					<s:if test="payAmount > 0"><label for="inputEmail3" class="control-label">Receipt No</label><span>: <%if(loginfo.isSeq_no_gen()){%><%-- (<b><s:property value="advrefsrno"/></b>) --%>(<s:property value="physical_paymentid"/>)<%}else{} %>  <s:property value="invoiceid"/></span></s:if><s:else><label for="inputEmail3" class="control-label">Receipt No</label><span>:  <%if(loginfo.isSeq_no_gen()){%><%-- (<b><s:property value="advrefsrno"/></b>) --%>(<s:property value="physical_paymentid"/>)<%}else{} %> <s:property value="invoiceid"/></span></s:else><label for="inputEmail3" class="control-label hidden-print">&nbsp; | &nbsp; Receipt Date</label><span class="hidden-print">: <s:property value="date"/></span>
				</div>
				<div class="form-group visible-print hidden-lg hidden-md hidden-sm" style="margin-bottom: 3px;">
					<label for="inputEmail3" class="control-label">Receipt Date</label><span>: <s:property value="date"/></span>
				</div>
				<div class="form-group" style="margin-bottom: 3px;">
					<label for="inputEmail3" class="control-label">UHID</label><span>: <s:property value="abrivationid"/> </span>&nbsp;|&nbsp;<label for="inputEmail3" class="control-label">IPD No</label><span>: <%if(loginfo.getIpd_abbr_access()==1){ %>
