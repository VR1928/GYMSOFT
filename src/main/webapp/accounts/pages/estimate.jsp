...
<div class="">
				...
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding-left:0px;padding-right:0px;">
						...
						<div class="col-lg-4 col-md-4 col-xs-4">
							...
							<s:if test="actionType==0">
                                                <b class="setticolors">ESTIMATE</b>        		
                                                        	</s:if>
                                                        	<s:else>
                                                        	<b class="setticolors">CHARGES</b>	
                                                      		</s:else>
						</div>
						</div>
					...
					<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 text-right" style="padding-left:0px;padding-right:0px;">
						<div class="form-group marbot3" style="margin-bottom: 3px;">
							<label for="inputEmail3" class="control-label">Date</label><span>: <s:property value="date"/></span> 
						</div>
						<div class="form-group marbot3" style="margin-bottom: 3px;">
							<label for="inputEmail3" class="control-label">Charge No</label><span>:<s:property value="invoiceid"/></span> 
						</div>
						<div class="form-group marbot3" style="margin-bottom: 3px;">
							<label for="inputEmail3" class="control-label">Payee Name</label><span>: <s:property value="payeename"/></span> 
						</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin-top: 20px;padding: 0px;">
					...
					<div class="col-lg-2 col-xs-3 col-md-3 col-sm-3 setotas">
                                            			...
                                            			<p style="margin: 0px 0px 4px 0px;">Total :</p>
                                            			
                   </div>
                   <div class="col-lg-2 col-xs-3 col-md-3 col-sm-3 setotas">
                                            			<p style="margin: 0px 0px 4px 0px;"><span style=""><%=Constants.getCurrency(loginfo)%><s:property value="totalAmountx"/></span></p>
                                            			
                                            			
                                            			
                  </div>
					<div>
					<span>Prepared by :<s:property value="preparedby"/></span>
					</div>
