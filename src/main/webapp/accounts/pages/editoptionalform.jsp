...
<s:form action="updateoptimalformNotAvailableSlot" id="saveoptionalform" theme="simple" method="post">
	...
	<div class="row">
		...
		<div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="padding-top: 10px;">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-left" style="padding-left:0px;padding-right:0px;">
				<div class="form-group" style="margin-bottom: 3px;">
					<b>Consultant : <s:property value="practitonerName"/> (<s:property value="userQualification"/>) | <s:property value="jobtitle"/></b>
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-left" style="padding-left:0px;padding-right:0px;">
				...
				<div class="col-lg-3 col-xs-3 col-sm-3">
					...
					<table class="table table-bordered table-responsive">
						<tbody>
							...
							<tr>
								<td>Un aided</td>
								<td><s:textfield cssClass="form-control" name="re_unaided_d" id="re_unaided_d" /></td>
								<td><s:textfield cssClass="form-control" id="re_unaided_n" name="re_unaided_n" /></td>
							</tr>
							<tr>
								<td>With Glass</td>
								<td><s:textfield cssClass="form-control" id="re_withglass_d" name="re_withglass_d" /></td>
								<td><s:textfield cssClass="form-control" id="re_withglass_n" name="re_withglass_n" /></td>
							</tr>
							<tr>
								<td>GT+P.H</td>
								<td><s:textfield cssClass="form-control" id="re_gtph_d" name="re_gtph_d" /></td>
								<td><s:textfield cssClass="form-control" id="re_gtph_n" name="re_gtph_n" /></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="col-lg-3 col-xs-3 col-sm-3">
					...
					<table class="table table-bordered table-responsive">
						<tbody>
							...
							<tr>
								<td><s:textfield cssClass="form-control" name="le_unaided_d" id="le_unaided_d" /></td>
								<td><s:textfield cssClass="form-control" id="le_unaided_n" name="le_unaided_n" /></td>
							</tr>
							<tr>
								<td><s:textfield cssClass="form-control" id="le_withglass_d" name="le_withglass_d" /></td>
								<td><s:textfield cssClass="form-control" id="le_withglass_n" name="le_withglass_n" /></td>
							</tr>
							<tr>
								<td><s:textfield cssClass="form-control" id="le_gtph_d" name="le_gtph_d" /></td>
								<td><s:textfield cssClass="form-control" id="le_gtph_n" name="le_gtph_n" /></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="col-lg-3 col-xs-3 col-sm-3">
					...
					<table class="table table-bordered table-responsive">
						<tbody>
							...
							<tr>
								<td>Air</td>
								<td><s:textfield cssClass="form-control" id="air_r" name="air_r" /></td>
								<td><s:textfield cssClass="form-control" id="air_l" name="air_l" /></td>
							</tr>
							<tr>
								<td>Perkins</td>
								<td><s:textfield cssClass="form-control" id="perkins_r" name="perkins_r" /></td>
								<td><s:textfield cssClass="form-control" id="perkins_l" name="perkins_l" /></td>
							</tr>
							<tr>
								<td>Appl</td>
								<td><s:textfield cssClass="form-control" id="appl_r" name="appl_r" /></td>
								<td><s:textfield cssClass="form-control" id="appl_l" name="appl_l" /></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="col-lg-3 col-xs-3 col-sm-3">
					...
					<table class="table table-bordered table-responsive">
						<tbody>
							<tr>
								<td><s:textfield cssClass="form-control" id="keratometry1" name="keratometry1" /></td>
								<td><s:textfield cssClass="form-control" id="keratometry2" name="keratometry2" /></td>
							</tr>
							<tr>
								<td><s:textfield cssClass="form-control" id="keratometry3" name="keratometry3" /></td>
								<td><s:textfield cssClass="form-control" id="keratometry4" name="keratometry4" /></td>
							</tr>
							<tr>
								<td><s:textfield cssClass="form-control" id="keratometry5" name="keratometry5" /></td>
								<td><s:textfield cssClass="form-control" id="keratometry6" name="keratometry6" /></td>
							</tr>
							<tr>
								<td><s:textfield cssClass="form-control" id="keratometry7" name="keratometry7" /></td>
								<td><s:textfield cssClass="form-control" id="keratometry8" name="keratometry8" /></td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div class="col-lg-6 col-xs-6 col-sm-6">
					...
					<table class="table table-bordered table-responsive">
						<tbody>
							...
							<tr>
								<td>Using Glass</td>
								<td><s:textfield cssClass="form-control" id="re_usingglass_s" name="re_usingglass_s" /></td>
								<td><s:textfield cssClass="form-control" id="re_usingglass_c" name="re_usingglass_c" /></td>
								<td><s:textfield cssClass="form-control" id="re_usingglass_a" name="re_usingglass_a" /></td>
								<td><s:textfield cssClass="form-control" id="re_usingglass_va" name="re_usingglass_va" /></td>
								<td><s:textfield cssClass="form-control" id="re_usingglass_nv" name="re_usingglass_nv" /></td>
								<td><s:textfield cssClass="form-control" id="re_usingglass_add" name="re_usingglass_add" /></td>
							</tr>
							<tr>
								<td>A.R</td>
								<td><s:textfield cssClass="form-control" id="re_ar_s" name="re_ar_s" /></td>
								<td><s:textfield cssClass="form-control" id="re_ar_c" name="re_ar_c" /></td>
								<td><s:textfield cssClass="form-control" id="re_ar_a" name="re_ar_a" /></td>
								<td><s:textfield cssClass="form-control" id="re_ar_va" name="re_ar_va" /></td>
								<td><s:textfield cssClass="form-control" id="re_ar_nv" name="re_ar_nv" /></td>
								<td><s:textfield cssClass="form-control" id="re_ar_add" name="re_ar_add" /></td>
							</tr>
							<tr>
								<td>Ace</td>
								<td><s:textfield cssClass="form-control" id="re_ace_s" name="re_ace_s" /></td>
								<td><s:textfield cssClass="form-control" id="re_ace_c" name="re_ace_c" /></td>
								<td><s:textfield cssClass="form-control" name="re_ace_a" id="re_ace_a" /></td>
								<td><s:textfield cssClass="form-control" id="re_ace_va" name="re_ace_va" /></td>
								<td><s:textfield cssClass="form-control" name="re_ace_nv" id="re_ace_nv" /></td>
								<td><s:textfield cssClass="form-control" id="re_ace_add" name="re_ace_add" /></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="col-lg-6 col-xs-6 col-sm-6">
					...
					<table class="table table-bordered table-responsive">
						<tbody>
							...
							<tr>
								<td><s:textfield cssClass="form-control" name="le_usingglass_s" id="le_usingglass_s" /></td>
								<td><s:textfield cssClass="form-control" id="le_usingglass_c" name="le_usingglass_c" /></td>
								<td><s:textfield cssClass="form-control" name="le_usingglass_a" id="le_usingglass_a" /></td>
								<td><s:textfield cssClass="form-control" id="le_usingglass_va" name="le_usingglass_va" /></td>
								<td><s:textfield cssClass="form-control" name="le_usingglass_nv" id="le_usingglass_nv" /></td>
								<td><s:textfield cssClass="form-control" id="le_usingglass_add" name="le_usingglass_add" /></td>
							</tr>
							<tr>
								<td><s:textfield cssClass="form-control" name="le_ar_s" id="le_ar_s" /></td>
								<td><s:textfield cssClass="form-control" id="le_ar_c" name="le_ar_c" /></td>
								<td><s:textfield cssClass="form-control" name="le_ar_a" id="le_ar_a" /></td>
								<td><s:textfield cssClass="form-control" id="le_ar_va" name="le_ar_va" /></td>
								<td><s:textfield cssClass="form-control" name="le_ar_nv" id="le_ar_nv" /></td>
								<td><s:textfield cssClass="form-control" id="le_ar_add" name="le_ar_add" /></td>
							</tr>
							<tr>
								<td><s:textfield cssClass="form-control" name="le_ace_s" id="le_ace_s" /></td>
								<td><s:textfield cssClass="form-control" id="le_ace_c" name="le_ace_c" /></td>
								<td><s:textfield cssClass="form-control" name="le_ace_a" id="le_ace_a" /></td>
								<td><s:textfield cssClass="form-control" id="le_ace_va" name="le_ace_va" /></td>
								<td><s:textfield cssClass="form-control" name="le_ace_nv" id="le_ace_nv" /></td>
								<td><s:textfield cssClass="form-control" id="le_ace_add" name="le_ace_add" /></td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="padding-top: 10px;">
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-right" style="padding-left:0px;padding-right:0px;">
					<div class="form-group" style="margin-bottom: 3px;">
						...
						<input type="submit" class="btn btn-primary savebtn savebigbtn" style="line-height: 45px;" value="Update">
					</div>
				</div>
			</div>
		<div class="col-lg-1 col-md-1"></div>
