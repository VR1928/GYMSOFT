...
<body>
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding: 0px;">
									 <s:form theme="simple" action="salereportProduct" >
										...
										<div class="col-md-6">
				                           <div class="form-inline">
					                            ...
					                            <div class="form-group">
					                           		<span class="text-uppercase"><b>Sale Report</b> &nbsp; - &nbsp;</span>
					                           </div>
												...
												<div class="form-group" style="width: 22%">
													...
													<div class="form-group" style="width:20%;">
														<s:select name="billtype" id="paymode" 
																list="#{'':'Payment Mode','Card':'Card','Cash':'Cash','Credit':'Credit','NEFT':'NEFT','Cheque':'Cheque'}"
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 hidden-lg hidden-sm hidden-md visible-print" style="padding: 0px;">
										<center><h3>Daily Sale Report <small>(From Date:04/07/2017 | To Date:04/07/2017)</small></h3> </center>	
									</div>
									<table class="table table-bordered table-striped xlstable" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
					                                <thead>
					                                    <tr class="tableback">
					                                       ...
					                                       <th style="width: 6%;" class='hidden'>Decimal Amount</th>
					                                    </tr>
					                                </thead>
					                                <tfoot style="background-color: rgba(245, 245, 245, 0.64);color: green;">
					                                	...
					                                	<td></td>
					                                	<td></td>
					                                	<td class="text-right"><s:property value="gstamt"/></td>
					                                	<td class="text-right"><s:property value="gstamt"/></td>
					                                	<td class="text-right"><s:property value="totaldebit"/></td>
					                                	<td class="text-right"><s:property value="totalReceived"/></td>
					                                	<td></td>
					                                	<td></td>
					                                	<td></td>
					                                	<td class="text-right"><s:property value="ttldisc"/></td>
					                                	 <td class="text-right hidden"><s:property value="finaldeciamount"/></td> 
					                                	</tr>
					                                </tfoot>
					                                <tbody>
					                                  ...
					                                  <%int i=0; %>
					                                    ...
					                                    <tr>
					                                        ...
					                                        <td><s:property value="discount"/></td>
					                                         <td class='hidden'><s:property value="decimalbillamount"/></td> 
					                                    </tr>
					                                    </s:iterator>	
					                                    
					                                </tbody>
					                            </table><br>
					                         	<s:form action="salereportProduct" name="paginationForm" id="paginationForm" theme="simple">
