...
<div class="col-lg-12 col-md-12 paddingnil">
	<s:form theme="simple" cssClass="form-inline search" id="transferreportformid" action="transferreportProduct">
	<div class="col-lg-12 col-md-12 topback2">
	
	<!-- div class="col-lg-10 col-md-10"> -->
		<form class="form-inline search">
		<div class="form-group">
			<span class="text-uppercase"><b>Indent Statement Report</b> &nbsp; - &nbsp;</span>
		</div>
		<br>
	<div class="form-group">
	...
	<div class="form-group" style="width:15%">
		<s:select headerKey="0" headerValue="To location" cssClass="form-control chosen-select" list="locationlist" name="location_filter" listKey="id" listValue="name"/>
	</div>
	<div class="form-group" style="width:15%">
...
<h4 class="hidden-lg hidden-md hidden-sm hidden-xs visible-print"
	...
	<table class="table table-bordered table-striped" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
		<thead>
			<tr class="tableback">
                ...
                <!-- <th style="text-align: center;width: 17%;">Indent No</th> -->
             </tr>
		</thead>
		<tbody>
			...
			<s:iterator value="parenttransferlist">
				...
				<!-- Hidden -->
				<s:if test="requestedmedicineList.size!=0">
				<tr>
				<td></td>
				<td colspan="9">
	...
	<s:form action="transferreportProduct" name="paginationForm" id="paginationForm" theme="simple">
