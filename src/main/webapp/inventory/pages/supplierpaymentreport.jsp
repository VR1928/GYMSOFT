...
<s:form theme="simple" cssClass="form-inline search" action="supplierpaymentreportProduct">
	...
	<div class="col-lg-9 col-md-9 col-sm-9 hidden-print" style="padding: 0px;">
		<div class="form-group">
			<span class="text-uppercase"><b>Supplier Payment Report</b> &nbsp; - &nbsp;</span>
		</div>
		<div class="form-group" style="width: 25%;">
			<s:select list="vendorList" cssClass="form-control chosen-select" listKey="id" listValue="name" name="vendor_id" headerKey="0" headerValue="All (Select Supplier)"></s:select>
		</div>
...
<h4 class="hidden-lg hidden-md hidden-sm hidden-xs visible-print"
	style="text-align: center; border-bottom: 4px double #ddd; line-height: 30px;"><b>Supplier Payment Report</b></h4>
	...
	<table class="table table-bordered table-striped" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
		<thead>
			<tr class="tableback">
				...
				<th style="width: 20% !important;">Supplier Name</th>
				<th style="width: 7% !important;">GRN No.</th>
				<th style="width: 7% !important;">Invoice No</th>
				<th style="width: 7% !important;">Invoice Date</th>
				<th style="width: 7% !important;">Location</th>
				<th style="width: 7% !important;">Payment Date</th>
				<th style="width: 7% !important;">Bank Name</th>
				<th style="width: 7% !important;">Cheque No.</th>
				<th style="width: 7% !important;">Cheque Type</th>
				<th style="width: 7% !important;">Cheque Maker</th>
				<th style="width: 9% !important;">Handover To</th>
				<th style="width: 9% !important;">Payment Amt.</th>
				<th style="width: 7% !important;">Balance Amt.</th> 
				<th style="width: 7% !important;">Print</th> 
			</tr>
		</thead>
		<tbody>
		    <% int j=0; %>
			<s:iterator value="supplierpaymentlist">
				<tr>
					<td><%=(++j)%></td>
					...
					<td><s:property value="locationame" /></td>
					...
					<td class="text-right">Rs.<s:property value="paymentAmount"/></td>
					<td class="text-right">Rs.<s:property value="balance"/></td> 
					<td><a href="#" onclick="openPopup('printpaymentProcurement?payid=<s:property value="parentid"/>')"><i class="fa fa-print"></i></a></td>
				</tr>
			</s:iterator>
		</tbody>
	</table>
...
<br>
<s:form action="supplierpaymentreportProduct" name="paginationForm" id="paginationForm" theme="simple">
							     <s:hidden name="vendor_id"></s:hidden>
							     <s:hidden name="fromdate"></s:hidden>
							     <s:hidden name="todate"></s:hidden>
							     <s:hidden name="paymentstatus"></s:hidden>
