				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow flag-nav">
						<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
							<img src="assets/img/flags/us.png" alt="" height="20"> English
						</a>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a class="active" href="estimates.html">Estimates</a></li>
								...
								<table class="table table-striped custom-table mb-0">
									...
									<tbody>
										<tr>
											...
											<td>17 Mar 2019</td>
											<td>$2099</td>
											<td><span class="badge badge-success-border">Accepted</span></td>
											<td class="text-right">
										...
										<tr>
											...
											<td>17 Mar 2019</td>
											<td>$2099</td>
											<td><span class="badge badge-danger-border">Declined</span></td>
											<td class="text-right">
												<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
													<div class="dropdown-menu dropdown-menu-right">
										...
										<tr>
											...
											<td>17 Mar 2019</td>
											<td>$2099</td>
											<td><span class="badge badge-warning-border">Expired</span></td>
											<td class="text-right">
												<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
													<div class="dropdown-menu dropdown-menu-right">
