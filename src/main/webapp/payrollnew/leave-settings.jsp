						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a class="active" href="leave-settings.html">Leave Settings</a></li>
                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card-box leave-box" id="leave_hospitalisation">
								...
								<div class="custom-policy">
									<div class="leave-header">
										<div class="title">Custom policy</div>
										<div class="leave-action">
											<button class="btn btn-sm btn-primary" type="button"><i class="fa fa-plus"></i> Add custom policy</button>
										</div>
									</div>
									<div class="table-responsive">
										<table class="table table-hover table-nowrap leave-table">
							...
							<!-- Custom Create Leave -->
							<div class="card-box leave-box" id="leave_custom01">
								<div class="h3 card-title with-switch">
									LOP 											
									<div class="onoffswitch">
