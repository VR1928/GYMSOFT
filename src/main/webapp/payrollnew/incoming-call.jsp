					...
					<div class="call-wrapper">
						<div class="call-inner">
							...
							<div class="call-items">
								<a href="chat.html" class="btn call-item call-end"><i class="material-icons">call_end</i></a>
								<a href="video-call.html" class="btn call-item call-start"><i class="material-icons">call</i></a>
							</div>
						</div>
					</div>
				</div>
