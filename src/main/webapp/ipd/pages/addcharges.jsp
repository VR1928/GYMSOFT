...
<div class="row">
	<div class="col-lg-12" id="durationdiv">
		...
		<%if(loginfonew.getIskunal()==1){ %>
		<span><input type="button" value="Modify TP Packages" onclick="showpkgsapplied()" class='btn btn-primary'></span>
		<%} %>
	</div>
</div>
...
<table class="table table-bordered" cellspacing="0" width="100%">
										...
										<tbody>
												<tr>
													<td>
														<input type="radio" name="payBuy" id="payBuynew"  value="0" checked="checked" style="display: inline; float: left;padding: 3px;"> <label for="payBuy" style="display: inline; padding: 3px;">Self</label><hr>
														<input type="radio" name="payBuy" id="payBuy1new"  value="1" style="display: inline; float: left;padding: 3px;"><label for="payBuy" style="display: inline; float: left;padding: 3px;">TP</label>
													</td>
													<td>
														<div >
													...
													<td>
														...
														<% String readOnly="";
														if(!loginfonew.isAdd_manual_charge()){ %>
