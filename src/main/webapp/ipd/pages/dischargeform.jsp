...
<div class='<%=nicuhide%>'>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
		<div class="form-group">
               <label for="exampleInputName2"><b>FAMILY HISTORY</b></label>
         </div>
		<div class="form-group" style="margin-top:10px;">
   ...
   <div style="margin-top: 20px !important;margin-bottom: 20px !important;">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px !important;margin-bottom: 20px !important;">
		...
		<div class="form-group" style="padding-right: 20px">
               <label for="exampleInputName2"><b>ON EXAMINATION</b></label>
               </div>
               <div class="form-group">
 ...
 --%>
			...
			<s:else>
				<div class="" id="treatmentgivendiv">
					...
					<div class="form-inline">
									<div class="form-group">
								          <label for="exampleInputName2"><b>PRISCRIPTION TEXT</b></label>
								     </div>
								      <div class="form-group">
								    <s:select list="discharge_default_list"
			...
			<div class="">
					<div class="col-lg-12 col-xs-12 col-md-12 textprime">
						<h5>
							How and When Get Emergency Details&nbsp;<%-- <span class="tooltip"><i
								class="fa fa-info-circle fa-2x"></i><span class="tooltiptext">A
			...
			<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="form-group">
						<br>
               <label for="exampleInputName2"><b><s:if test="daycare"><>PROCEDURAl</s:if> NOTES</b></label>
         </div>
							<div class="form-inline">
								<div class="form-group" style="width: 100%;">
									<s:select list="discharge_default_list"
