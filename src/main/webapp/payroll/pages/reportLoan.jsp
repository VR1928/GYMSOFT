...
<body id="his" class="appWrapper sidebar-xs-forced">
        ...
        <section id="">
              ...
              <div class="container-fluid">
					<a>
                        <h3><strong>Loan</strong> Report</h3>
                    </a>
                    </div>
          

            <div class="page page-sidebar-xs-layout" id="">
                            ...
                            <table style="margin:0 auto;" border="0" cellpadding="0" cellspacing="0" height="46" width="100%">
                                <tbody style="background-color: rgb(242, 242, 242);">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             <b>Branch Name :</b>
                                            <s:select name="branch" id="branch" list="branchlist" listKey="branch_id" listValue="branch" onchange="sortLoan(this.value)" cssClass="selectstyle">
                                           </s:select>
                                        </td>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="4" align="right">
                                        <a href="loanPayrollMaster" style="text-decoration:none;">
