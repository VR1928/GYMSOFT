...
<body id="his" class="appWrapper sidebar-xs-forced">
        ...
        <section id="">
          ...
          <div class="container-fluid">
					<a>
                        <h3><strong>Salary</strong> Report</h3>
                    </a>
                    </div>      
                            ...
                            <table style="margin:0 auto;" border="0" cellpadding="0" cellspacing="0" height="46" width="100%">
                                <tbody style="background-color: rgb(242, 242, 242);">
                                    <tr>
                                        ...
                                        <td style="width: 20%;">
                                             <b>Branch Name :</b>
                                            <s:select name="branch" id="branch" list="branchlist" listKey="branch_id" onchange="sortSalary(this.value)" listValue="branch" cssClass="selectstyle">
                                           </s:select>
                                        </td>
                                       
                                        <td>
                                            <b>Date :</b><input class="hasDatepicker"name="attdate1" size="9" value="2016-03-25" type="text">
                                        </td>
                                        <td>
