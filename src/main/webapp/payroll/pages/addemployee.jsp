 ...
 <div class="col-md-10 col-lg-10 col-xs-12 col-sm-12">
								...
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="background-color: #339966">
										<h4 style="background-color: #339966">Add New Employee</h4>
									</div>
								</div>
								<div class="row">
                                        		...
                                        		<div class="col-lg-12 col-md-12">
													<div class="row">
														<div class="form-inline">
															...
															<input type="text" id="adhno" name="adhno" class="form-control" placeholder="Enter Aadhar No">
														</div>
														<div class="form-group">
							...
							<div class="col-lg-3 col-md-3" id="collierydiv" >
							  ...
							  <a href="#" onclick="addNewDoctorSurgery()" class="btn btn-primary" > <i class="fa fa-plus"></i> New GP/Hospital</a>
								...
								<div class="col-lg-12 col-md-12 text-right">
									<s:submit value="Add Employee" onclick="addUpdateEmployee()" cssClass="btn btn-primary" style="background-color: #339966"/>
