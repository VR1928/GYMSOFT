            				...
            				<td class="tdtable">
								...
								<!-- <div class="btnseparator"></div> -->
             					<div  id="showmonthbtn" class="fbutton dayme martop2das">
                					<%-- <div>
                						<span  class=""> 
                							<s:textfield theme="simple" cssClass="form-control" cssStyle="height: 20px; padding: 3px" id="commencing"   name="commencing" onchange="showdisplaynewopd()"></s:textfield>
                						</span>
                					</div> --%>
                					<div class="input-group ">
                                          <span class="input-group-addon opdcalendarwidth" id="basic-addon1"><i class="fa fa-calendar"></i></span>
                                          <s:textfield theme="simple"  name="commencing" cssClass="form-control calenderne"  aria-describedby="basic-addon1" id="commencing" onchange="showdisplaynewopd()"/>
                                      </div><!-- /input-group -->
                						...
                						<div  id="showmonthbtn" class="fbutton hidden-xs hidden-sm">
            	 							<div style="margin-top: 2px;">
            	 								<span  class="">
              										...
              										<input onclick="showpopupfornewopd()" type="button" id="printcomdashboard" value=" Book Appointment " class="btn" style="background-color: #eee;border-color: #ccc;color: black;"/>
                								</span>
                							</div>
                						</div>
                						...
                						<div  id="showmonthbtn" class="fbutton hidden-xs hidden-sm">
            	 							<div style="margin-top: 2px;">
            	 								<span  class="">
              										...
              										<input onclick="showdisplaynewopd()" type="button" id="printcomdashboard" value=" Refresh " class="btn" style="background-color: #eee;border-color: #ccc;color: black;"/>
                								</span>
                							</div>
                						</div>
						...
						<!--  <div class="btnseparator hidden-xs hidden-sm"></div> -->
								 ...
								 <!--  <div class="btnseparator hidden-xs hidden-sm"></div> -->
            	 					<div  id="showmonthbtn" class="fbutton martop2das hidden">
            	 						<div>
            	 							<span  class="">
            	 								<s:form action="calNotAvailableSlot?actionType=newopdday" id="dayfrm">
