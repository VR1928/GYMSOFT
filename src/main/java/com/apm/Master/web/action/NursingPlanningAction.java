...
public class NursingPlanningAction extends BaseAction implements ModelDriven<MasterForm>,Preparable{
	...
	public String execute() throws Exception{
		...
		try {
			...
			int count = masterDAO.getTotalNursingPlanningCount();
			...
			ArrayList<Master>nursingplanninglist = masterDAO.getAllNursingPlanning(searchText, pagination);
			masterForm.setNursingplanninglist(nursingplanninglist);
			mastername=request.getParameter("selectedid");
			pagination.setPage_records(nursingplanninglist.size());
	...
	public String add(){
		...
		try {
			...
			ArrayList<Master>nursingdiagnosislist = masterDAO.getAllNursingDiagnosis(null, null);
	...
	public String save() throws Exception{
		...
		try {
		    ...
		    master.setNursing_planning(masterForm.getNursing_planning());
				int result = masterDAO.addNursingPlanning(master);
	...
	public String delete(){
		...
		try {
		    ...
		    int i = master.getId();
			int result = masterDAO.deleteNursingPlanning(master);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return "save";
