...
public class PureSevaLoginAction extends BaseAction implements ModelDriven<BranchForm> {
	...
	public String execute() throws SQLException{
		...
		try{
			...
			loginInfo.setLoginType("pureseva");
		...
		if(!uhid.equals("")){
			...
			if(checkemalidexist){*/
				int clientid = clientDAO.getPureSevaClientid(uhid);
